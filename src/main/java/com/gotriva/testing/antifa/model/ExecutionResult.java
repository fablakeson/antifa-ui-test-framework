...
public class ExecutionResult {
    ...
    /**
     * Adds a new step to execution result. The execution fails if the step
     * is a FAIL. Otherwise, the execution result remains unknown until the
     * finish method call.
     * 
    ...
    /**
     * Marks current execution result as finished with SUCCESS.
     * It will not accept new steps after.
     */
    public void finish() {
